...
export default function PokeCardV3({ poke, index, sortKey }: PokeCardProps) {
  const {
    dexNumber,
    nameKo,
    formKo,
    ...
    >
      ...
      <div className="flex px-5 gap-3 pt-5 ">
        <div className="flex-1 flex gap-3.5 ">
          <div className="flex items-center justify-center aspect-square bg-muted/70 rounded-4xl p-1">
