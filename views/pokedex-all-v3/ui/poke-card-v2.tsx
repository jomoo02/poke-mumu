...
export default function PokeCardV2({ poke, index, sortKey }: PokeCardProps) {
  const {
    dexNumber,
    nameKo,
    formKo,
  ...
  return (
    ...
    >
      <div className="p-5 pb-0">
        <div className="text-foreground/50 font-semibold text-xl font-suite">
          #{index}
        </div>
      </div>

      <div className="flex px-5 gap-3 pt-5 pb-5">
        <div className="flex-1 flex flex-col items-center justify-center ">
          ...
          <div
            className={cn(
              'shrink-0 font-medium tabular-nums pt-1.5',
          ...
          <div className="">
            <div
              className={cn(
                'text-lg font-medium min-w-0 truncate text-center',
                isActive('name') && 'text-primary',
              )}
            >
              {nameKo}
            </div>
            <div className="text-sm h-5 text-muted-foreground  font-medium min-w-0 truncate text-center">
              {formKo}
            </div>
          </div>
        ...
        <div className="flex flex-col gap-2">
          {stats.map((stat) => {
            ...
            return (
              <div key={stat.label} className="flex items-center">
                <div
                  className={cn(
                    'text-md w-14 text-right shrink-0',
          ...
          <div className="flex items-center">
            <div
              className={cn(
                'shrink-0 font-meium text-md w-14 text-right',
            ...
            <div
              className={cn(
                'shrink-0 font-medium tabular-nums text-center w-14',
