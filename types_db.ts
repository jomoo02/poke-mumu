  ...
  public: {
    Tables: {
      ...
      evolution_condition: {
        ...
        Relationships: [
          {
            foreignKeyName: "evolution_condition_evolution_detail_id_fkey"
            columns: ["evolution_detail_id"]
            isOneToOne: false
            referencedRelation: "evolution_detail"
            referencedColumns: ["id"]
          },
        ]
      }
      evolution_detail: {
        ...
        Relationships: [
          {
            foreignKeyName: "evolution_detail_evolution_node_id_fkey"
            columns: ["evolution_node_id"]
            isOneToOne: false
            referencedRelation: "evolution_node"
            referencedColumns: ["id"]
          },
        ]
      }
      evolution_node: {
        ...
        Relationships: [
          {
            foreignKeyName: "evolution_node_evolution_chain_id_fkey"
            columns: ["evolution_chain_id"]
            isOneToOne: false
            referencedRelation: "evolution_chain"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "evolution_node_evolution_chain_id_fkey"
            columns: ["evolution_chain_id"]
            isOneToOne: false
            referencedRelation: "evolution_summary"
            referencedColumns: ["chain_id"]
          },
          {
            foreignKeyName: "evolution_node_parent_node_id_fkey"
      ...
      poke: {
        ...
        Relationships: [
          {
            foreignKeyName: "poke_evolution_id_fkey"
      ...
      version_group_content: {
        ...
        Relationships: [
          {
            foreignKeyName: "version_group_content_version_group_id_fkey"
            columns: ["version_group_id"]
            isOneToOne: true
            referencedRelation: "version_group"
            referencedColumns: ["id"]
