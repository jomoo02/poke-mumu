...
export default async function PokedexDexNumberFormPageUIVV2({
  pokeKey,
  dexNumber,
  ...
  return (
    <Suspense>
      <div
        className={cn(
          ' mx-auto w-full py-10 relative max-w-7xl px-4 sm:px-6 xl:px-10',
        )}
      >
        <section>
        ...
        <section>
          <SectionTitle id="rest-info">기타정보</SectionTitle>
