...
export default function Container({ pokes, types }: PokedexTableProps) {
  ...
  return (
    <div className="w-full">
      <ScrollToTopButton />
      <div className="flex gap-4 sm:gap-6 justify-between sm:justify-center pb-4 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-14 w-full">
      ...
      <div className="md:px-8 lg:px-10 xl:px-14 w-full relative">
        <PokedexTable
          pokes={sortedPokes}
          bodyRef={bodyRef}
          headerRef={headerRef}
