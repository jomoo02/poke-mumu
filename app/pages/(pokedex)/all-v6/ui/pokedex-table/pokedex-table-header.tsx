...
export default function PokedexTableHeader({
  ...
  return (
    ...
    <div ref={ref} className="sticky top-0 z-2 w-full">
      <div className="flex w-full relative h-12 min-w-300 2xl:min-w-350">
        <div
          className={cn(
            'w-20 min-w-20 md:w-26 md:min-w-26 sticky left-0 bg-card border-b z-10 shrink-0 ',
