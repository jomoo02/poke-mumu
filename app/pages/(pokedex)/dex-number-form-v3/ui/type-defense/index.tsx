...
export default function TypeDefenses({
  ...
  return (
    <div className="">
      <div className="text-3xl font-bold pb-4">방어 상성</div>
      ...
      <div className="max-w-6xl">
        {data.map(({ types, label }, index) => (
          <Fragment key={label}>
            {index > 0 && <div className="h-px w-full bg-border my-4" />}
            <div className="flex flex-col lg:flex-row gap-6">
              <div className="font-medium flex lg:justify-center items-center w-28">
                {label}
              </div>
              <div className="lg:col-span-3 grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 xl:grid-cols-7 gap-6 flex-1">
