...
export default function usePokedexV2(pokes: NationalPokeView[]) {
  ...
  const handleChangeSortKey = useCallback((newSortKey: SortKey) => {
    startTransition(() => {
  ...
  const handleChangeDirection = useCallback((newDirection: Direction) => {
