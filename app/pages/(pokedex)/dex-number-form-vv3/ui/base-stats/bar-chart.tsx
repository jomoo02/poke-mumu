    ...
    <div className="w-full bg-card overflow-hidden">
      <Table className="">
        ...
        <TableBody className="">
          {statsMinMax.map((stat) => (
            <Fragment key={stat.stat}>
              <TableRow key={stat.stat} className="border-b bg-transparent">
                <TableCell className="w-[14%] pl-0">{stat.label}</TableCell>
                <TableCell className="text-center w-[12%]  ">
                  {stat.value}
                </TableCell>
                <TableCell className="w-[74%] sm:w-[50%] ">
        ...
        <TableFooter className="border-t bg-transparent">
          <TableRow className="">
            <TableCell className="pl-0">총합</TableCell>
