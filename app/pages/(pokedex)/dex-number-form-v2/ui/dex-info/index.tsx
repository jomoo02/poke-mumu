...
export default function DexInfo({ dexInfo }: DexInfoProps) {
  ...
  return (
    <div className="grid lg:grid-cols-2 w-full gap-6 ">
      {/* <div className="aspect-square sm:aspect-4/2 lg:aspect-square rounded-2xl p-6 flex justify-center items-center overflow-hidden"> */}
      <div className="rounded-xl h-full w-full relative mx-auto flex justify-center items-center">
        <PokeArtwork className="object-contain w-full" poke={poke} priority />
      </div>
      {/* </div> */}
