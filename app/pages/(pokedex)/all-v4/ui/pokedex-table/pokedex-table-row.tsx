...
export default function PokedexTableRow({
  ...
  return (
    <div className="h-full  flex  group hover:bg-muted">
      {/* <div
        className={cn(
      ...
      >
        <div className="bg-card w-20 min-w-20 md:w-26 md:min-w-26 h-full flex justify-center items-center group-hover:bg-muted">
