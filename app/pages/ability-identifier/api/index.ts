// app/pages/ability/[identifier]/api/index.ts

import { createClient } from '@/app/shared/lib/supabase/client';
import { type AbilityView, AbilityPokeView } from '../model';

/**
 * Ability detail 페이지에 표시할 ability 단건 정보.
 */
 ...
 */
export async function getPokes(abilityId: number): Promise<AbilityPokeView[]> {
  const supabase = createClient();
